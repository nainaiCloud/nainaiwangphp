        ...
        <script type="text/html" id="contractTemplat">
                    ...
                    <tr style="height:35px">
                       <td style="padding:0 10px"><%=contDatas.pro_name%></td>
                        ...
                        <td style="padding:0 10px" id='areatextarea'>
                            <%=contDatas.product.produce_area%> &nbsp;
                            <%=contDatas.product.produce_address%>    
                        </td>
                    </tr>
                </table>
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">二、数量
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第二条 买卖双方通过电子交易平台成交的数量：______<%=contDatas.max_num%>____________。（以竞价交易中双方达成的交易数量为准） 。（以竞价交易中双方达成的约定为准）</li>
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">三、保证金
                <ol style=" margin-top:5px;">
                    ...
                    <li style="text-indent: 20px;"> 第六条：保证金赔付：（1）需要在竞价结束后<%=contDatas.pay_days%>天内支付全部货款，否则保证金相应扣除作为违约赔付。（2）需要在卖方规定的交收时间内交收完成，否则保证金按照1元/吨/天的仓储费用相应扣除。</li>
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">五、交收地点
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第十条  本合同项下货物的交收地点在交易所指定的交收地，该商品交收地为___<%=contDatas.accept_area_code%>_<%=contDatas.accept_area%>____________。（（以竞价交易中约定的交收地点，或买卖双方自行约定的交收地点为准）</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">六、交收时间及期限
                <ol style=" margin-top:5px;">
                    ...
                    <li style="text-indent: 20px;">第十二条 甲乙双方通过交易平台电子交易系统就当日订立成功的产品申报交收，交收需按照交易平台的有关规定进行。</li>
                     <li style="text-indent: 20px;">第十三条   甲方在向乙方转移货权之日起，超过______日（以竞价交易中双方约定的交收时间为准）未出库部分，乙方应按仓库要求支付相关仓储费用。仓储费用为：1元/吨/天。</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">七、质量标准及异议处理
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">用于交收的产品应符合以下规定：</li>
                    <li style="text-indent: 20px;">第十四条  以竞价交易中双方达成的交易的产品质量为准。</li>
