    ...
    <div class="cd-popup-container_ht">
        ...
        <script type="text/html" id="contractTemplat">
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">五、交收地点
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第九条 本合同项下货物的交收地点在交易所指定的交收地，该商品交收地为___<%=contDatas.accept_area_code%>_<%=contDatas.accept_area%>____________。（以竞价交易中约定的交收地点，或买卖双方自行约定的交收地点为准）</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">六、交收时间及期限
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第十条 本合同从输入交易指令后达成交易即视为合同生效，直至合同履约完毕。</li>
                    <li style="text-indent: 20px;">第十一条 甲乙双方通过交易平台电子交易系统就当日订立成功的产品申报交收，交收需按照交易平台的有关规定进行。</li>
                     <li style="text-indent: 20px;">第十二条  甲方在向乙方转移货权之日起，超过   日（以竞价交易中双方约定的交收时间为准）未出库部分，乙方应按仓库要求支付相关仓储费用。</li>
                </ol>
            </div>
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">八、货款结算与手续费
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第十七条 本合同成立后，按照《耐耐云商科技有限公司交易管理办法》（需确认网站是否有此管理办法，现阶段暂无）的规定，进行货款结算。买卖双方自主交收或另有协议的以甲乙双方另行签订的补充协议为准。</li>
                    <li style="text-indent: 20px;">第十八条  甲方在收到买方本合同全额货款后，向乙方转移货权。</li>
            ...
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">十二、合同的签署
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第二十三条 买卖双方登录耐耐网电子交易平台现货竞价交易系统，并输入交易指令后达成交易即视为买卖双方签署本合同，本合同即行生效。（与以上第十条提到的合同生效节点不一致）</li>
                </ol>
            </div>
            <div style="padding-left:20px; line-height:25px; margin-top:10px;">十三、其他条款
                <ol style=" margin-top:5px;">
                    <li style="text-indent: 20px;">第二十四条 本合同一式两份，甲乙双方各执一份。传真件盖章有效。</li>
