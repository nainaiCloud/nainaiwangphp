				...
				<div class="bidbond_top clear">
					...
					<div class="bidbond_right">
						<div class="bidbondsm clear">
							...
							<div class="sm_con">
								<p>1、此保证金仅适用于该竞价商品</p>
								<p>2、未竞价成功，保证金于竞价结束后3个工作日内原路退回</p>
								<p>3、若竞价成功，保证金于交收完毕后3个工作日内原路退回。保证金赔付适用以下情形：（1）需要在竞价结束后<span class="payment_day"><!-- 3 --></span>天内支付全部货款，否则保证金相应扣除作为违约赔付（2）需要在卖方规定的交收时间内交收完成，否则保证金按照1元/吨/天的仓储费用相应扣除。</p>
							</div>
						</div>
					</div>
				</div>
