			...
			<div class="bidpricelist_con clear">
				...
				<div class="bid_rule">
					...
					<div class="bidrule_content">
						...
						<p class="bidruletk">
							1.5 释放保证金：（1）未竞价成功，保证金于竞价结束后3个工作日内原路退回。（2）若竞价成功，保证金于交收完毕后3个工作日内原路退回。
						</p>
						<p class="bidruletk">1.6保证金赔付：（1）在卖方规定的货款缴纳时间内支付全部货款，否则保证金相应扣除作为违约赔付（2）需要在卖方规定的交收时间内交收完成，否则保证金按照1元/吨/天的仓储费用相应扣除。</p>
