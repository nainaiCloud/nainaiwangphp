			...
			<div class="bidpricelist_con clear">
				...
				<div class="bid_rule">
					...
					<div class="bidrule_content">
						...
						<p class="bidruletk">1.1买家可以同时参与多个商品的竞拍。一个商品的保证金仅适用于该竞价商品。</p>
						<p class="bidruletk">1.2 出价前买方须提前缴纳保证金。买方缴纳保证金后，点击缴纳完成，系统将自动检测是否缴纳成功。缴纳成功即可获得竞拍资格。</p>
						<p class="bidruletk">
							1.3 缴纳保证金账户必须为在耐耐网的开户账户信息，否则造成保证金缴纳失败由买方自行承担。
						</p>
						<p class="bidruletk">
							1.4 买方可使用该保证金在竞价规定时间内进行多次出价。
						</p>
						<p class="bidruletk">
							1.5 释放保证金：（1）未竞价成功，保证金于竞价结束后1个工作日内原路退回。（2）若竞价成功，保证金于交收完毕后1个工作日内原路退回。
						</p>
						<p class="bidruletk">1.6保证金赔付：（1）需要在竞价结束后2个小时内支付全部货款，否则保证金相应扣除作为违约赔付（2）需要在卖方规定的交收时间内交收完成，否则保证金按照1元/吨/天的仓储费用相应扣除。</p>
						<p class="bidrule_bt">2.竞拍时间</p>
						<p class="bidruletk">2.1 竞价时间为卖方发布竞价时设置的时间。</p>
						<p class="bidruletk">2.2 竞价开始时间为发布时间的2个工作日后，结束时间晚于开始时间。</p>
